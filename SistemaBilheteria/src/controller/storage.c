...
void meusBilhetes(Bilheteria *bilheteria, int indice) {
    ...
    snprintf(nome_arquivo, sizeof(nome_arquivo), "..//data//bilhete_%03d.txt", b.numero_bilhete); // Essa parte aqui e para gerar o nome
